 ...
 */
public class SubscriberSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SubscriberSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// retrieve the SOAP session client
        ...
        filter.setProperty("EmailAddress");
        filter.setSimpleOperator(SimpleOperators.LIKE);
        filter.getValue().add(search);
