    ...
    extends FilterPart
{
    ...
    public SimpleFilterPart(String property, SimpleOperators simpleOperator, List<String> values, List<Calendar> dateValue) {
    	this.property = property;
    	this.simpleOperator = simpleOperator;
    	this.value = values;
    	List<XMLGregorianCalendar> xmlgregorian = new ArrayList<XMLGregorianCalendar>();
    	if (null != dateValue) {
    		for (Calendar cal : dateValue) {
	    		GregorianCalendar gregorian = new GregorianCalendar();
	    		gregorian.setTime(cal.getTime());
	    		try {
					xmlgregorian.add(DatatypeFactory.newInstance().newXMLGregorianCalendar(gregorian));
				} catch (DatatypeConfigurationException e) {
					// Do nothing
				}
	    	}
    	}
    	this.dateValue = xmlgregorian;
    }
