...
public class AccountDataItem {
    ...
    @XmlElementRef(name = "BrandID", namespace = "http://exacttarget.com/wsdl/partnerAPI", type = JAXBElement.class)
    protected JAXBElement<Integer> brandID;
    @XmlElementRef(name = "PrivateLabelID", namespace = "http://exacttarget.com/wsdl/partnerAPI", type = JAXBElement.class)
    protected JAXBElement<Integer> privateLabelID;
    @XmlElementRef(name = "AccountType", namespace = "http://exacttarget.com/wsdl/partnerAPI", type = JAXBElement.class)
    ...
    public void setBrandID(JAXBElement<Integer> value) {
        this.brandID = ((JAXBElement<Integer> ) value);
    }
    ...
    public void setPrivateLabelID(JAXBElement<Integer> value) {
        this.privateLabelID = ((JAXBElement<Integer> ) value);
    }
    ...
    public void setAccountType(JAXBElement<Integer> value) {
        this.accountType = ((JAXBElement<Integer> ) value);
    }
