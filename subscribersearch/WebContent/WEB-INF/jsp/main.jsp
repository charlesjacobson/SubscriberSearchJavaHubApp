...
<head>
    <title>SubscriberSearch-java: Default</title>
    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <meta name="viewport" content="width=device-width,initial-scale=1" />
    <meta name="description" content="Java FuelUX based App" />
	...
	<script  type="text/javascript">
		...
		$(document).ready(function () {
		    ...
		    $('.viewDetails').live('click', function () {
		        var $url = "./subscriberretrieve?id=" + this.id;
		        $.ajax({ url: $url,
		    ...
		    $('.saveStatus').live('click', function () {
		        var $url = "./subscriberupdate?id=" + this.id + "&status=" + $('#statusValue').combobox().val();
		        $.ajax({ url: $url,
	    ...
	    <div id="app-nav" class="navbar navbar-inverse navbar-fixed-top">
		    <div class="navbar-inner">
			    <div class="container-fluid">
				    <a href="/" class="brand">Java Version</a>
			    </div>
		    </div>
	    </div>
